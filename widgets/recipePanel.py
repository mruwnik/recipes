...
class RecipePanel ( wx.Panel ):
    ...
    def __init__( self, parent ):
        ...
        self.title = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTRE )
        self.title.Wrap( -1 )
        container.Add( self.title, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )
        
        self.description = rt.RichTextCtrl(self, style=wx.TE_READONLY|wx.NO_BORDER)
        container.Add( self.description, 1, wx.ALL|wx.EXPAND, 5 )
        
        self.algorythm = rt.RichTextCtrl(self, style=wx.VSCROLL|wx.HSCROLL|wx.TE_READONLY|wx.NO_BORDER)
        ...
        extra_info = wx.GridSizer( 2, 2, 0, 0 )
        
        self.groups_label = wx.StaticText( self, wx.ID_ANY, u"groups:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.groups_label.Wrap( -1 )
        extra_info.Add( self.groups_label, 0, wx.ALL, 5 )
        
        self.groups = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.groups.Wrap( -1 )
        extra_info.Add( self.groups, 0, wx.ALL, 5 )
        
        self.cost_label = wx.StaticText( self, wx.ID_ANY, u"cost:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.cost_label.Wrap( -1 )
        extra_info.Add( self.cost_label, 0, wx.ALL, 5 )
        
        self.cost = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.cost.Wrap( -1 )
        extra_info.Add( self.cost, 0, wx.ALL, 5 )
        
        self.time_label = wx.StaticText( self, wx.ID_ANY, u"time:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.time_label.Wrap( -1 )
        extra_info.Add( self.time_label, 0, wx.ALL, 5 )
        
        self.time = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.time.Wrap( -1 )
        extra_info.Add( self.time, 0, wx.ALL, 5 )
        
        self.difficulty_label = wx.StaticText( self, wx.ID_ANY, u"difficulty:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.difficulty_label.Wrap( -1 )
        extra_info.Add( self.difficulty_label, 0, wx.ALL, 5 )
        
        self.difficulty = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
