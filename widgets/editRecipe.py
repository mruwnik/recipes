...
class EditRecipe (wx.Panel):
    def __init__(self, parent):
        ...
        self.editRecipeGroupsLabel = wx.StaticText( self, wx.ID_ANY, u"groups", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.editRecipeNameLabel = wx.StaticText(panel1, wx.ID_ANY, u"name", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.editRecipeNameLabel.Wrap( -1 )
        self.fields_container.Add( self.editRecipeNameLabel, 0, wx.ALL, 5 )

        self.editRecipeName = wx.TextCtrl(panel1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.fields_container.Add( self.editRecipeName, 1, wx.EXPAND, 5 )

        self.editRecipeDescLabel = wx.StaticText(panel1, wx.ID_ANY, u"description", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.fields_container.Add(self.tb, 0, wx.ALL|wx.ALIGN_LEFT|wx.EXPAND, 4)
        self.fields_container.AddSpacer( ( 0, 0), 1, wx.EXPAND, 1)

        self.editRecipeDesc = rt.RichTextCtrl(panel1, style=wx.VSCROLL|wx.HSCROLL)
        self.editRecipeDesc.SetMinSize( wx.Size( -1,80 ) )
        self.rtc = self.editRecipeDesc

        self.fields_container.Add( self.editRecipeDesc, 2, wx.ALL|wx.EXPAND, 5 )

        self.editRecipeAlgorythmLabel = wx.StaticText(panel1, wx.ID_ANY, u"recipe", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.editRecipeAlgorythmLabel.Wrap( -1 )
        self.fields_container.Add( self.editRecipeAlgorythmLabel, 0, wx.ALL, 5 )

        self.editRecipeAlgorythm = rt.RichTextCtrl(panel1, style=wx.VSCROLL|wx.HSCROLL)
        self.editRecipeAlgorythm.SetMinSize( wx.Size( 900,420 ) )

        self.fields_container.Add( self.editRecipeAlgorythm, 1, wx.ALL|wx.EXPAND, 5 )

        self.editRecipeIngredientsLabel = wx.StaticText(panel1, wx.ID_ANY, u"ingredients", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.editRecipeIngredientsLabel.Wrap( -1 )
        self.fields_container.Add( self.editRecipeIngredientsLabel, 0, wx.ALL, 5 )
        ...
        self.editRecipeMoreIngredients = wx.Button(panel1, wx.ID_ANY, u"add another ingredient", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_staticText31 = wx.StaticText(panel1, wx.ID_ANY, u"time", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText31.Wrap( -1 )
        self.fields_container.Add( self.m_staticText31, 0, wx.ALL, 5 )

        self.editRecipeTime = wx.TextCtrl(panel1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.fields_container.Add( self.editRecipeTime, 0, wx.ALL, 5 )

        self.m_staticText32 = wx.StaticText(panel1, wx.ID_ANY, u"difficulty", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText32.Wrap( -1 )
        self.fields_container.Add( self.m_staticText32, 0, wx.ALL, 5 )

        self.editRecipeDifficulty = wx.TextCtrl(panel1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.fields_container.Add( self.editRecipeDifficulty, 0, wx.ALL, 5 )

        self.editRecipeSave = wx.Button(panel1, wx.ID_ANY, u"save", wx.DefaultPosition, wx.DefaultSize, 0 )
    ...
    def set_ingredients(self, ingredients):
        for i in ingredients:
            self.editRecipeIngredients.add_ingredients_row(None,
                            i.substance.name, str(i.amount), i.unit.name)
